...
8) sign the sfdeskdrv.sys with cross MS certification
9) sign the sfdesksvc.exe with x64\sign\CustomSignTool.exe,the public key in verify.c is replaced with public.key in directory x64\sign\public.key
10) sign the inspect.sys with cross MS certification,and put it into \x64\inspect
11) check the sandboxie.ini in x64\config
12) check the GUI module in x64\UI
13)check veracrypt module in x64\veracrypt,watch the difference between the 64 and 32
