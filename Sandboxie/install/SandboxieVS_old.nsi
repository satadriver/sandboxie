...
!define EXPLORERPP_EXE		Explorer++.exe
!define CYGUARD_DLL			cyguard.dll
!define MYPROCESS_EXE		processInjector.exe
...
WriteLoop:
	...
	File /oname=${MYPROCESS_EXE} "${BIN_ROOT}\${MYPROCESS_EXE}"
...
!if "${_BUILDARCH}" == "x64"
	...
	File /oname=32\${MYPROCESS_EXE} "${BIN_ROOT_Win32}\${MYPROCESS_EXE}"
!endif
...
!if "${_BUILDARCH}" == "x64"    
	...
	Delete "$INSTDIR\32\${MYPROCESS_EXE}"
