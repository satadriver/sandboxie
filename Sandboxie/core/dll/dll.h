...
enum {
	...
	DLL_IMAGE_SHELL_EXPLORER_PLUSPLUS,
...
typedef struct _THREAD_DATA {
	...
	HDC gui_hdcBackground;
	HBITMAP gui_hbmpBackground;
	int gui_mainWindowLeft;
	int gui_mainWindowTop;
	int gui_mainWindowWidth;
	int gui_mainWindowHeight;

	//WCHAR g_copypath[256];
	//WCHAR g_truepath[256];
...
extern __declspec(dllexport) const WCHAR *Dll_HomeDosPath;
