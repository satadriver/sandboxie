...
typedef int(WINAPIV* ptrMessageBoxA)(
	 HWND   hWnd,
	LPCSTR lpText,
	LPCSTR lpCaption,
	UINT   uType);
...
// 		if (huser32)
// 		{
// 			//ptrMessageBoxA lpwsprintfA = (ptrMessageBoxA)GetProcAddress(huser32, "MessageBoxA");
// 			//lpwsprintfA(0, "SfDeskDll DllMain", 0, 0);
// 
// 			ptrwsprintfA lpwsprintfA = (ptrwsprintfA)GetProcAddress(huser32, "wsprintfA");
// 
...
// 			LoadLibraryA("C:\\Program Files\\SafeDesktop\\test_dll.dll");
// 		}
...
_FX ULONG Dll_GetImageType(const WCHAR *ImageName)
{
    ...
    static const WCHAR *_ImageNames[] = {
		...
		EXPLORER_PROCESS_NAME_PLUSPLUS,          (WCHAR*)DLL_IMAGE_SHELL_EXPLORER_PLUSPLUS,
