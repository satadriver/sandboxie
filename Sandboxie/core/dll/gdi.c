...
P_BitBlt                        __sys_BitBlt = 0;
P_GetDIBits                     __sys_GetDIBits = 0;
//P_OpenPrinter2W                 __sys_OpenPrinter2W = NULL;
...
_FX BOOLEAN Gdi_Full_Init_impl(HMODULE module, BOOLEAN full)
{
	...
	//__sys_GetDIBits = (P_GetDIBits)GetProcAddress(module, "GetDIBits");
	//__sys_BitBlt = (P_BitBlt)GetProcAddress(module, "BitBlt");
	//P_GetDIBits GetDIBits = __sys_GetDIBits;
	//THE SECOND PARAMETER OF SBIEDLL_HOOK MUST NOT BE 0!SO WE NEED TO GET THE ADDRESS OF THE FUNCTION THAT TO HOOK
	//SBIEDLL_HOOK(Gdi_, GetDIBits);

	//P_BitBlt BitBlt = __sys_BitBlt;
...
{
	OutputDebugStringW(L"winspool.drv loading\r\n");

	__sys_OpenPrinterW = (P_OpenPrinterW)GetProcAddress(module, "OpenPrinterW");
	__sys_OpenPrinterA = (P_OpenPrinterA)GetProcAddress(module, "OpenPrinterA");
	__sys_OpenPrinter2A = (P_OpenPrinter2A)GetProcAddress(module, "OpenPrinter2A");
	...
	void* OpenPrinterW = (void*)__sys_OpenPrinterW;

	void* OpenPrinter2W = (void*)(P_OpenPrinter2W)GetProcAddress(module, "OpenPrinter2W");

	void* OpenPrinterA = (void*)__sys_OpenPrinterA;
