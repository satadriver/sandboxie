...
enum {
	...
	API_SET_PROCESS_MONITOR,
	API_RESET_PROCESS_MONITOR,

	API_SET_SCREENSHOT,
	API_QUERY_SCREENSHOT,

	API_QUERY_FILEEXPORT,
	API_SET_FILEEXPORT,
...
API_ARGS_BEGIN(API_VERACRYPT_COPYFILE_ARGS)
API_ARGS_FIELD(WCHAR*, dst)
API_ARGS_FIELD(WCHAR*, src)
API_ARGS_CLOSE(API_VERACRYPT_COPYFILE_ARGS)
...
API_ARGS_BEGIN(API_RESET_PROCESS_MONITOR_ARGS)
API_ARGS_CLOSE(API_RESET_PROCESS_MONITOR_ARGS)

API_ARGS_BEGIN(API_SET_PROCESS_MONITOR_ARGS)
API_ARGS_FIELD(WCHAR*, processname)
API_ARGS_CLOSE(API_SET_PROCESS_MONITOR_ARGS)


API_ARGS_BEGIN(API_SET_SCREENSHOT_ARGS)
API_ARGS_FIELD(VOID*, enable)
API_ARGS_CLOSE(API_SET_SCREENSHOT_ARGS)

API_ARGS_BEGIN(API_SET_WATERMARK_ARGS)
API_ARGS_FIELD(VOID*, enable)
API_ARGS_CLOSE(API_SET_WATERMARK_ARGS)

API_ARGS_BEGIN(API_SET_PRINTER_ARGS)
API_ARGS_FIELD(VOID*, enable)
API_ARGS_CLOSE(API_SET_PRINTER_ARGS)

API_ARGS_BEGIN(API_SET_FILEEXPORT_ARGS)
API_ARGS_FIELD(VOID*, enable)
API_ARGS_CLOSE(API_SET_FILEEXPORT_ARGS)

API_ARGS_BEGIN(API_USERNAME_PASSWORD_ARGS)
API_ARGS_FIELD(int, type)
API_ARGS_FIELD(int, operation)
API_ARGS_FIELD(WCHAR*, data)
API_ARGS_CLOSE(API_USERNAME_PASSWORD_ARGS)
...
typedef struct _SVC_PROCESS_MSG {
    ...
    BOOLEAN bHostInject;
    ULONG reason;
    WCHAR process_name[128];	//CAN NOT BE 256,BECUASE IT WILL OVERFLOW STRUCT BUFFER!
