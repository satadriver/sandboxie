...
int __cdecl mytestlog(const WCHAR* format, ...) {
	WCHAR szbuf[0x1000];
...
MSG_HEADER *ProcessServer::RunSandboxedHandler(MSG_HEADER *msg)
{
	...
	mytestlog(L"service start process cmd:%ws,dir:%ws,env:%ws\r\n",cmd,dir,env);
...
// 		msg.bHostInject = TRUE;
// 		msg.add_to_job = 0;
// 		msg.create_time = 0;
// 		BYTE iswow64 = 0;
// 		result = IsWow64Process(pi->hProcess, (PBOOL)&iswow64);
// 		msg.is_wow64 = iswow64;
// 		msg.process_id = pi->dwProcessId;
// 		msg.session_id = 0;
// 		msg.reason = TRUE;
// 		WCHAR* pos = wcsrchr(cmd, L'\\');
// 		if (pos)
// 		{
// 			wcsncpy(msg.process_name, pos + 1, 64);
// 		}
// 		else {
// 			wcsncpy(msg.process_name, cmd, 64);
// 		}
// 		result = hookProcess(&msg);
