...
__declspec(dllimport) NTSTATUS __stdcall NtSuspendProcess(HANDLE hProcess);

__declspec(dllimport) NTSTATUS __stdcall NtResumeProcess(HANDLE hProcess);
